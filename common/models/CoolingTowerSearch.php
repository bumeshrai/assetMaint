...
/**
 * CoolingTowerSearch represents the model behind the search form about `common\models\CoolingTower`.
 */
class CoolingTowerSearch extends CoolingTower
{
    ...
    {
        return [
            [['cooling_tower_id', 'freq_id', 'monthly_cleaning', 'quarterly_cleaning', 'daily_sensible_check', 'quarterly_sensible_check', 'quarterly_lubrication_check', 'monthly_electrical_check', 'quarterly_electrical_check', 'quarterly_mechanical_check', 'maint_type_id', 'eng_id'], 'integer'],
