...
/**
 * VacFanSearch represents the model behind the search form about `common\models\VacFan`.
 */
class VacFanSearch extends VacFan
{
    ...
    {
        return [
            [['vac_fan_id', 'freq_id', 'quarterly_cleaning', 'quarterly_electrical_check', 'maint_type_id', 'eng_id'], 'integer'],
