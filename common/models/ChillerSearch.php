...
use common\models\Chiller;

/**
 * ChillerSearch represents the model behind the search form about `common\models\Chiller`.
 */
class ChillerSearch extends Chiller
{
    ...
    {
        return [
            [['chiller_id', 'freq_id', 'quarterly_functional_check', 'quarterly_leak_testing_check', 'daily_record_the_reading', 'quarterly_record_the_reading', 'quarterly_sensible_check', 'quarterly_electrical_check', 'maint_type_id', 'eng_id'], 'integer'],
