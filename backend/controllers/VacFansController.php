...
use Yii;
use common\models\VacFan;
use common\models\VacFanSearch;
...
/**
 * VacFansController implements the CRUD actions for VacFan model.
 */
class VacFansController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all VacFan models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new VacFanSearch();
    ...
    /**
     * Displays a single VacFan model.
     * @param integer $id
     * @return mixed
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && ($model->freq_id > 0 && $model->freq_id < 10)) {
            ...
            if ($model->save()) {
                return $this->redirect(['view', 'id' => $model->vac_fan_id]);
            }
        } else {
    ...
    /**
     * Updates an existing VacFan model.
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->fan_id]);
        } else {
    ...
    /**
     * Deletes an existing VacFan model.
    ...
    /**
     * Finds the VacFan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return VacFan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = VacFan::findOne($id)) !== null) {
            return $model;
        } else {
