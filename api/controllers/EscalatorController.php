...
class EscalatorController extends ActiveController
{
  public $modelClass = 'common\models\Escalator';
  ...
  public function actionIndex($id)
    {
        return \common\models\Escalator::find()->where(['freq_id' => $id])->one();    
    }

    public function actionCreate()
    {
        $model = new \common\models\Escalator();
        $response = array();
