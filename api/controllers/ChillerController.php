...
class ChillerController extends ActiveController
{
  public $modelClass = 'common\models\Chiller';
  ...
  public function actionIndex($id)
    {
        return \common\models\Chiller::find()->where(['freq_id' => $id])->one();    
    }

  public function actionCreate()
    {
        $model = new \common\models\Chiller();
        $response = array();
