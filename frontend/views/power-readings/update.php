...
$this->title = 'Update Power Reading: ' . $model->reading_id;
$this->params['breadcrumbs'][] = ['label' => 'Power Readings', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->reading_id, 'url' => ['view', 'id' => $model->reading_id]];
...
<div class="col-md-6">
    ...
    <?= $form->field($model, 'supply')->radioList(array('110'=>'110 KV',33=>'33 KV', 25=>'25 KV'));  ?>
