...
class ReportgenSearch extends Equipment
{
    ...
    {
        return [
            [['bddate','equip_id', 'corr_id', 'ename_id', 'manuf_id', 'enos_id', 'level_id', 'stn_id', 'installation_date', 'asset_code', 'last_major_overhaul', 'last_minor_maintenance'], 'integer'],
            [['fromdate','todate','deptName','bdassetcode','totalFailure','breakdownId','equipment_name', 'station_name', 'located_at',], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        if($this->fromdate && $this->todate){
          ...
          $to=$this->todate;
          $tdate=strtotime($to);
          $query->where(['between','breakdown.reporting_time' , $fdate, $tdate]);
